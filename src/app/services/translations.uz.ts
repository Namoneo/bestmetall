  ...
  services: {
    produce: {
      ...
      equipment: [
        ...
        'List bukish mashinasi (3000 mm gacha uzunlikda bukish)',
        'Truba bukish mashinalari (dornli va valtsli, 10 dan 50 mm gacha trubalarni bukish)',
        'Valtslar (list va profilni radiusli bukish)',
        'Payvandlash postlari (argon-yoy payvandlash TIG, yarim avtomatik MIG)',
        'Va avtomatik hamda laserli payvandlash (nochka hajmda ovoz)',
